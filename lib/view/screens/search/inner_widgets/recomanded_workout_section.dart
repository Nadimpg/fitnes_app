...
class RecomandedWorkoutSection extends StatefulWidget {
  const RecomandedWorkoutSection({super.key});

  @override
  State<RecomandedWorkoutSection> createState() => _RecomandedWorkoutSectionState();
}

class _RecomandedWorkoutSectionState extends State<RecomandedWorkoutSection> {
  List<Map<String , String>> category = [
    ...
    {
      "image": AppImages.fullBody ,
      "exerciseType": AppStrings.fullBody,
      "time":AppStrings.minutes,
      "level" : AppStrings.intermediate,
    },
    {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: SingleChildScrollView(
        child: Column(
            children: List.generate(category.length, (index) =>  Container(
