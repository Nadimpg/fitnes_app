...
class IntermediateSection extends StatefulWidget {
  const IntermediateSection({super.key});

  @override
  State<IntermediateSection> createState() => _IntermediateSectionState();
}

class _IntermediateSectionState extends State<IntermediateSection> {
